...
with a forged frame and lock
out the frames that follow it, and that the same bytes are refused for the same reason however often they
...
signature covers. A room state and a closing come from the host key,
